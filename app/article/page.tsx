...
function ArticlePage({ searchParams }: Props) {
  ...
  return (
    <article>
        <section
            className="flex flex-col lg:flex-row pb-24 px-0 lg:px-10"
        >
            { article.image && (
                <img
            ...
            >
                <h1
                    className="headerTitle px-0 no-underline pb-2"
                >
                    {article.title}
                </h1>
                
                <div
                    className="flex divide-x-2 space-x-4"
                >
                    ...
                    <p className="pt-12 lg:pt-4 mx-0 sm:mx-12 lg:mx-0">{article.description}</p>
            </div>
        </section>
    </article>
  )
